...
def wrangle_zillow():
    ...
    df = df.rename(columns = {"bedroomcnt":"bedrooms", "bathroomcnt":"bathrooms","calculatedfinishedsquarefeet":"squarefeet","taxvaluedollarcnt": "total_taxes_assessed","fips":"county"})#renamed columns for easy readability as well
